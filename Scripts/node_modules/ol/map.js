...
import _ol_renderer_Map_ from './renderer/map';
 ...
 * @type {string}
 */
_ol_.OL_LOGO_URL = 'data:image/png;base64,' +
...
var _ol_Map_ = function(options) {
  ...
  _ol_events_.listen(this.controls_, _ol_CollectionEventType_.ADD,
      /**
  ...
  _ol_events_.listen(this.controls_, _ol_CollectionEventType_.REMOVE,
      /**
       * @param {ol.Collection.Event} event Collection event.
       */
      function(event) {
  ...
  _ol_events_.listen(this.interactions_, _ol_CollectionEventType_.ADD,
      /**
       * @param {ol.Collection.Event} event Collection event.
       */
      function(event) {
  ...
  _ol_events_.listen(this.interactions_, _ol_CollectionEventType_.REMOVE,
      /**
       * @param {ol.Collection.Event} event Collection event.
       */
      function(event) {
...
_ol_.inherits(_ol_Map_, _ol_Object_);
...
_ol_Map_.createOptionsInternal = function(options) {
  ...
  if (options.logo === undefined ||
    ...
    logos[_ol_.OL_LOGO_URL] = _ol_.OL_URL;
  } else {
  ...
  if (options.renderer !== undefined) {
    ...
    if (rendererTypes.indexOf(/** @type {ol.renderer.Type} */ ('dom')) >= 0) {
      rendererTypes = rendererTypes.concat(_ol_.DEFAULT_RENDERER_TYPES);
    }
  } else {
    rendererTypes = _ol_.DEFAULT_RENDERER_TYPES;
  }
  ...
  for (i = 0, ii = rendererTypes.length; i < ii; ++i) {
    ...
    if (_ol_.ENABLE_CANVAS && rendererType == _ol_renderer_Type_.CANVAS) {
      if (_ol_has_.CANVAS) {
        rendererConstructor = _ol_renderer_canvas_Map_;
        break;
      }
    } else if (false && rendererType == _ol_renderer_Type_.WEBGL) {
      if (_ol_has_.WEBGL) {
        rendererConstructor = _ol_renderer_webgl_Map_;
        break;
      }
    }
  }
  ...
  if (options.interactions !== undefined) {
    ...
    interactions = _ol_interaction_.defaults();
  }
