...
import _ol_geom_flat_topology_ from '../../geom/flat/topology';
import _ol_obj_ from '../../obj';
import _ol_render_webgl_ from '../webgl';
import _ol_render_webgl_Replay_ from '../webgl/replay';
import _ol_render_webgl_linestringreplay_defaultshader_ from '../webgl/linestringreplay/defaultshader';
...
if (false) {
  ...
  _ol_render_webgl_LineStringReplay_.prototype.setUpProgram = function(gl, context, size, pixelRatio) {
    ...
    if (!this.defaultLocations_) {
      ...
      locations = new _ol_render_webgl_linestringreplay_defaultshader_.Locations(gl, program);
