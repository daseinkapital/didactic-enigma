...
var _ol_render_webgl_imagereplay_defaultshader_ = {};
...
if (false) {
  ...
  _ol_render_webgl_imagereplay_defaultshader_.Fragment = function() {
    _ol_webgl_Fragment_.call(this, _ol_render_webgl_imagereplay_defaultshader_.Fragment.SOURCE);
  };
  _ol_.inherits(_ol_render_webgl_imagereplay_defaultshader_.Fragment, _ol_webgl_Fragment_);
   ...
   * @type {string}
   */
  _ol_render_webgl_imagereplay_defaultshader_.Fragment.SOURCE = _ol_.DEBUG_WEBGL ?
      _ol_render_webgl_imagereplay_defaultshader_.Fragment.DEBUG_SOURCE :
      _ol_render_webgl_imagereplay_defaultshader_.Fragment.OPTIMIZED_SOURCE;
  ...
  _ol_render_webgl_imagereplay_defaultshader_.Vertex = function() {
    _ol_webgl_Vertex_.call(this, _ol_render_webgl_imagereplay_defaultshader_.Vertex.SOURCE);
  };
  _ol_.inherits(_ol_render_webgl_imagereplay_defaultshader_.Vertex, _ol_webgl_Vertex_);
   ...
   * @type {string}
   */
  _ol_render_webgl_imagereplay_defaultshader_.Vertex.SOURCE = _ol_.DEBUG_WEBGL ?
      _ol_render_webgl_imagereplay_defaultshader_.Vertex.DEBUG_SOURCE :
      _ol_render_webgl_imagereplay_defaultshader_.Vertex.OPTIMIZED_SOURCE;
...
export default _ol_render_webgl_imagereplay_defaultshader_;