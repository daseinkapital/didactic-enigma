 ...
 */
_ol_VectorImageTile_.prototype.getContext = function() {
  if (!this.context_) {
 ...
 */
_ol_VectorImageTile_.prototype.getImage = function() {
 ...
 */
_ol_VectorImageTile_.prototype.getReplayState = function() {
...
_ol_VectorImageTile_.prototype.load = function() {
  ...
  if (this.state == _ol_TileState_.LOADING) {
    this.tileKeys.forEach(function(sourceTileKey) {
      ...
      if (sourceTile.state == _ol_TileState_.IDLE) {
        ...
        sourceTile.load();
      } else if (sourceTile.state == _ol_TileState_.ERROR) {
        errors = true;
      } else if (sourceTile.state == _ol_TileState_.EMPTY) {
        _ol_array_.remove(this.tileKeys, sourceTileKey);
      }
      if (sourceTile.state == _ol_TileState_.LOADING) {
        var key = _ol_events_.listen(sourceTile, _ol_events_EventType_.CHANGE, function(e) {
          ...
          if (state == _ol_TileState_.LOADED ||
            ...
            _ol_array_.remove(this.loadListenerKeys_, key);
            ...
            if (leftToLoad == 0) {
              this.setState(this.tileKeys.length > 0 ?
                  _ol_TileState_.LOADED : _ol_TileState_.ERROR);
            }
          }
        }.bind(this));
  ...
  if (leftToLoad == 0) {
    setTimeout(function() {
      this.setState(this.tileKeys.length > 0 ?
          _ol_TileState_.LOADED :
          (errors ? _ol_TileState_.ERROR : _ol_TileState_.EMPTY));
    }.bind(this), 0);
  }
};
