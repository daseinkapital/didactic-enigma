...
var _ol_source_VectorTile_ = function(options) {
  ...
  if (!this.tileGrid) {
    this.tileGrid = this.getTileGridForProjection(_ol_proj_.get(options.projection || 'EPSG:3857'));
  }
...
_ol_source_VectorTile_.prototype.getTilePixelRatio = function(opt_pixelRatio) {
  return opt_pixelRatio == undefined ?
      _ol_source_UrlTile_.prototype.getTilePixelRatio.call(this, opt_pixelRatio) :
      opt_pixelRatio;
};
